...
class __Mustache_c3e330483fd520f2de6cab0100784157 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext(array(
                'drawercontent' => array($this, 'block09c2b9c55c865f543fb00232b3c85f0e'),
            ));
...
';
    ...
    private function sectionD3c82464e5a9d1ee8b67353f2c28e6f5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' i/window_close, core, {{#str}} closebuttontitle {{/str}} ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
...
';
    ...
    public function block09c2b9c55c865f543fb00232b3c85f0e($context)
    {
        $indent = $buffer = '';
...
';
        ...
        $buffer .= $this->sectionD3c82464e5a9d1ee8b67353f2c28e6f5($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '                </a>
';
