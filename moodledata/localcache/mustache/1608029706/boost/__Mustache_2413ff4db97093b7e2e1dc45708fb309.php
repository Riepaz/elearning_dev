...
class __Mustache_2413ff4db97093b7e2e1dc45708fb309 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-group')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockA596040be5f3cee1ac2616e6c67b3dfc'),
            ));
...
';
    ...
    public function blockA596040be5f3cee1ac2616e6c67b3dfc($context)
    {
        $indent = $buffer = '';
