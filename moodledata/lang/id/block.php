...
/**
 * Strings for component 'block', language 'id', version '3.11'.
 *
 * @package     block
 * @category    string
...
$string['assignrolesinblock'] = 'Terapkan peranan pada {$a} blok';
...
$string['hidedockpanel'] = 'Sembunyikan panel dock';
$string['hidepanel'] = 'Sembunyikan panel';
$string['moveblock'] = 'Pindahkan {$a} blok';
