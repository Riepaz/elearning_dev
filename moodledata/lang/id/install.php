...
/**
 * Strings for component 'install', language 'id', version '3.11'.
 *
 * @package     install
 * @category    string
...
$string['nativemariadbhelp'] = '<p> Basis data adalah tempat sebagian besar pengaturan dan data Moodle disimpan dan harus dikonfigurasikan di sini. </p> <p> Nama basis data, nama pengguna, dan kata sandi adalah bidang wajib diisi; awalan tabel adalah opsional. </p> <p> Nama basis data hanya boleh berisi karakter alfanumerik, dolar ($) dan garis bawah (_). </p> <p> Jika basis data saat ini tidak ada, dan pengguna yang Anda gunakan tentukan memiliki izin, Moodle akan berusaha membuat database baru dengan izin dan pengaturan yang benar. </p> <p> Driver ini tidak kompatibel dengan mesin MyISAM lama. </p>';
$string['nativemysqli'] = 'Improved MySQL (native/mysqli)';
$string['nativemysqlihelp'] = '<p> Basis data adalah tempat sebagian besar pengaturan dan data Moodle disimpan dan harus dikonfigurasikan di sini. </p> <p> Nama basis data, nama pengguna, dan kata sandi adalah bidang wajib diisi; awalan tabel adalah opsional. </p> <p> Nama basis data hanya boleh berisi karakter alfanumerik, dolar ($) dan garis bawah (_). </p> <p> Jika basis data saat ini tidak ada, dan pengguna yang Anda gunakan tentukan memiliki izin, Moodle akan berusaha membuat basis data baru dengan izin dan pengaturan yang benar. </p>';
$string['nativeoci'] = 'Oracle (Native/oci)';
$string['nativeocihelp'] = 'Sekarang Anda perlu mengkonfigurasi basis data tempat sebagian besar data Moodle akan disimpan. Database ini harus sudah dibuat dan nama pengguna dan kata sandi dibuat untuk mengaksesnya. Awalan tabel adalah wajib.';
...
$string['nativesqlsrvhelp'] = 'Sekarang Anda perlu mengkonfigurasi basis data dimana sebagian besar data Moodle akan disimpan. Basis data ini harus sudah dibuat dan nama pengguna dan kata sandi dibuat untuk mengaksesnya. Awalan tabel adalah wajib.';
