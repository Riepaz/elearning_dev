...
$string['uploadcohorts_help'] = 'Kohor dapat diunggah melalui berkas teks. Format berkas harus sebagai berikut:<br /> * Setiap baris berkas berisi satu catatan <br />* Setiap catatan adalah serangkaian data yang dipisahkan oleh koma (atau pembatas lainnya) <br />* Catatan pertama berisi daftar nama bidang yang menentukan format dari sisanya berkas <br ./>* Nama bidang yang diperlukan adalah nama <br />* Nama bidang opsional adalahidnumber, description, descriptionformat, visible, context, category, category_id, category_idnumber, category_path';
