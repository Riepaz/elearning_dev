...
$string['enabledocumentationdescription'] = 'Detil dokumentasi web service yang tersedia untuk protokol yang diaktifkan.';
...
$string['missingpassword'] = 'Kehilangan kata kunci';
...
$string['onesystemcontrollingdescription'] = 'Langkah-langkah berikut membantu Anda untuk mengatur layanan web Moodle untuk memungkinkan sistem eksternal untuk berinteraksi dengan Moodle. Ini termasuk menyiapkan token (kunci keamanan) metode otentikasi.';
$string['operation'] = 'Operasi';
$string['optional'] = 'Opsional';
$string['passwordisexpired'] = 'Kata kunci kadaluarsa';
...
$string['requireauthentication'] = 'Metode ini memerlukan otentikasi dengan izin xxx.';
...
$string['restoredaccountresetpassword'] = 'Untuk mengembalikan akun harus me-reset password sebelum mendapatkan token.';
...
$string['selectedcapabilitydoesntexit'] = 'Saat ini pengaturan kemampuan yang diperlukan ({$a}) tidak ada lagi. Silahkan mengubahnya dan menyimpan perubahan.';
...
$string['simpleauthlog'] = 'Otentikasi login sederhana';
$string['step'] = 'Langkah';
$string['supplyinfo'] = 'Lebih detil';
$string['testauserwithtestclientdescription'] = 'Mensimulasikan akses eksternal ke layanan menggunakan klien uji layanan web. Sebelum melakukannya, masuk  sebagai pengguna dengan kemampuan moodle/webservice:createtoken dan mendapatkan kunci keamanan (token) melalui halaman preferensi pengguna. Anda akan menggunakan token ini dalam klien tes. Pada klien tes, juga memilih protokol diaktifkan dengan otentikasi tanda. <strong>PERINGATAN: Fungsi bahwa Anda menguji AKAN DILAKSANAKAN untuk pengguna ini, jadi hati-hati apa yang Anda pilih untuk menguji </strong>';
...
$string['testwithtestclientdescription'] = 'Mensimulasikan akses eksternal ke layanan menggunakan klien uji layanan web. Gunakan protokol diaktifkan dengan otentikasi tanda. <strong> PERINGATAN: Fungsi bahwa Anda menguji AKAN DILAKSANAKAN, jadi hati-hati apa yang Anda pilih untuk menguji </strong>';
$string['token'] = 'Token';
...
$string['userasclientsdescription'] = 'Langkah-langkah berikut membantu Anda untuk mengatur layanan web Moodle untuk pengguna sebagai klien. Langkah-langkah ini juga membantu untuk mengatur token direkomendasikan (kunci keamanan) metode otentikasi. Dalam kasus penggunaan ini, pengguna akan menghasilkan token mereka dari halaman kunci keamanan melalui halaman preferensi mereka.';
...
$string['wsaccessuserexpired'] = 'Menolak akses web service untuk kata sandi kadaluarsa untuk nama pengguna: {$a}';
$string['wsaccessusernologin'] = 'Menolak akses web service untuk nama pengguna dengan otentikasi Nologin: {$a}';
...
$string['wsdocumentationlogin'] = 'atau masukkan nama pengguna web service dan password:';
$string['wspassword'] = 'Kata sandi web service';
