...
$string['coursealreadyfinished'] = 'Kelas telah selesai';
$string['coursenotyetfinished'] = 'Kelas belum selesai';
$string['coursenotyetstarted'] = 'Kelas belum dimulai';
$string['coursetoolong'] = 'Kelas terlalu lama';
$string['customfield_islocked'] = 'Terkunci';
$string['customfield_islocked_help'] = 'Jika isian terkunci, hanya user yang berhak (biasanya yang mempunyai role manager)  yang bisa mengubahnya pada setting kelas.';
$string['customfield_notvisible'] = 'Tak seorangpun';
...
$string['customfieldsettings'] = 'Pengaturan bidang khusus kursus umum';
$string['errorendbeforestart'] = 'Tanggal akhir ({$a}) tertulis sebelum tanggal mulai kelas.';
$string['favourite'] = 'Kelas yang bertanda bintang';
$string['gradetopassnotset'] = 'Kelas atau kuliah ini tidak memiliki nilai lulus (passing grade). Ini dapat diatur di dalam hal penilaian kelas (Gradebook setup)';
...
<p>Sejumlah siswa di {$a->coursename} belum pernah mengakses kelas.</p>';
$string['nocourseactivity'] = 'Tidak cukup memiliki aktifitas kelas antara awal dan akhir kelas';
$string['nocourseendtime'] = 'Kelas tidak memiliki tanggal akhir';
$string['nocoursesections'] = 'Tidak ada bab di kelas';
$string['nocoursestudents'] = 'Tidak ada siswa';
$string['norecentaccessesinfomessage'] = 'Hai {$a->userfirstname},
<p>Sejumlah siswa di {$a->coursename} belum mengakses kelas akhir-akhir ini.</p>';
$string['noteachinginfomessage'] = 'Halo {$a->userfirstname},
<p>Kelas dengan tanggal mulai minggu depan telah teridentifikasi sebagai tak memiliki pendaftaran guru atau siswa. </p>';
...
$string['recommendcheckbox'] = 'Merekomendasikan aktifitas: {$a}';
$string['searchactivitiesbyname'] = 'Pencarian aktivitas berdasarkan nama';
$string['searchresults'] = 'Hasil pencarian: {$a}';
$string['studentsatriskincourse'] = 'Siswa dalam risiko di kelas {$a}';
$string['studentsatriskinfomessage'] = 'Hai {$a->userfirstname},
<p>Siswa di kelas {$a->coursename} teridentifikasi dalam risiko.</p>';
...
$string['target:coursecompletion'] = 'Siswa berisiko tidak memenuhi persyaratan penyelesaian mata pelajaran';
$string['target:coursecompletion_help'] = 'Target ini menjelaskan apakah siswa dianggap berisiko tidak memenuhi ketentuan penyelesaian pelajaran.';
...
$string['target:coursegradetopass'] = 'Siswa berisiko tidak mencapai nilai minimum untuk lulus mata pelajaran';
$string['target:coursegradetopass_help'] = 'Target ini menjelaskan apakah siswa berisiko tidak mencapai nilai minimum untuk lulus mata pelajaran.';
$string['target:noaccesssincecoursestart'] = 'Siswa-siswa yang belum mengakses kelas sama sekali.';
$string['target:noaccesssincecoursestart_help'] = 'Target ini menggambarkan siswa yang tidak pernah mengakses kelas tempat mereka terdaftar.';
$string['target:noaccesssincecoursestartinfo'] = 'Siswa berikut terdaftar dalam kelas yang telah dimulai, tetapi mereka belum pernah mengakses kelas tersebut.';
$string['target:norecentaccesses'] = 'Siswa yang belum mengakses kelas baru-baru ini';
...
$string['target:noteachingactivity'] = 'Kelas berisiko tidak dimulai';
$string['target:noteachingactivity_help'] = 'Target ini menjelaskan tentang apakah kelas yang akan dimulai minggu depan akan memiliki kegiatan mengajar.';
$string['target:noteachingactivityinfo'] = 'Kelas berikut yang akan dimulai dalam beberapa hari mendatang berisiko tidak dimulai karena tidak memiliki guru atau siswa yang terdaftar.';
$string['targetlabelstudentcompetenciesno'] = 'Siswa yang cenderung mencapai kompetensi yang ditugaskan pada suatu kelas';
$string['targetlabelstudentcompetenciesyes'] = 'Siswa berisiko tidak mencapai kompetensi yang ditugaskan pada suatu kelas';
$string['targetlabelstudentcompletionno'] = 'Siswa yang mungkin memenuhi persyaratan penyelesaian kelas';
...
$string['targetlabelstudentgradetopassyes'] = 'Siswa berisiko tidak memenuhi nilai minimum untuk lulus kelas.';
$string['targetlabelteachingno'] = 'Kelas yang berisiko tidak dimulai';
$string['targetlabelteachingyes'] = 'Pengguna dengan kemampuan mengajar yang memiliki akses ke kelas';
