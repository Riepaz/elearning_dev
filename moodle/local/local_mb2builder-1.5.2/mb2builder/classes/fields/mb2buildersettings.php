...
if (!class_exists('admin_setting_configmb2buildersettings') && class_exists('admin_setting'))
{
	...
	class admin_setting_configmb2buildersettings extends admin_setting
	{
		...
		public function local_mb2builder_font_icons()
		{
			...
			$output .= '<ul class="nav nav-tabs">';
			$output .= '<li class="nav-item active"><a class="nav-link active show" data-toggle="tab" href="#tab-font-icons-fa">Font Awesome</a></li>';
			$output .= '<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-font-icons-glyph">Glyphicons</a></li>';
			$output .= '<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-font-icons-7stroke">7 Stroke</a></li>';
			$output .= '</ul>';
