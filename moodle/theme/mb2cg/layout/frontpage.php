...
$sidebarPos = theme_mb2cg_theme_setting($PAGE, 'sidebarpos', 'right');
$sidebars = theme_mb2cg_theme_setting($PAGE, 'fpsidebars');
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="content-col <?php echo $contentCol; ?>">
                <div id="page-content">
					<?php if (theme_mb2cg_frontpage_courses() && theme_mb2cg_theme_setting($PAGE, 'courseswitchlayout')) : ?>
						<?php echo theme_mb2cg_course_layout_switcher(); ?>
					<?php endif; ?>
					<?php if (is_siteadmin()) : ?>
                    	<?php echo theme_mb2cg_check_plugins(); ?>
                    <?php endif; ?>
     		...
     		<?php if ($sidePost) : ?>
            	<div class="sidebar-col <?php echo $sidePostCol; ?>">
                	<?php echo $OUTPUT->blocks('side-post', theme_mb2cg_block_cls($PAGE, 'side-post')); ?>
                </div>
        	<?php endif; ?>
        </div>
    </div>
...
<?php
	...
	echo theme_mb2cg_page_builder_content($builderfptext);
?>
