            	...
            	<div id="page-content">
					<?php if ($PAGE->pagetype === 'user-profile') : ?>
						<div class="profile-user-picture">
							<?php
								$userid = theme_mb2cg_get_url_param($PAGE->url, 'id');
								echo theme_mb2cg_get_user_details($userid);
							?>
							<h1><?php echo theme_mb2cg_get_user_details($userid, 2); ?></h1>
						</div>
					<?php endif; ?>
					<?php if ($PAGE->pagetype === 'course-index-category' && isset($PAGE->category->id) && theme_mb2cg_theme_setting($PAGE, 'courseswitchlayout')) : ?>
