 ...
 *
 */
function theme_mb2cg_get_course_activities()
{
 ...
 *
 */
function theme_mb2cg_course_panel($name = '')
{
	...
	$output = '';
	$i= 0;
	$boxes = theme_mb2cg_teacher_boxes();
 ...
 *
 */
function theme_mb2cg_teacher_boxes()
{
	...
	$boxes = array(
		 'course' => array(
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2cg_course_content()
		),
		'activities' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-list-ul',
			'links' => theme_mb2cg_links_activities()
		),
		'grade' => array(
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2cg_grades_content()
		),
		'studentbadges' => array(
			'access' => array('student'),
			'title' => '',
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2cg_studentbadges_content()
		),
		'competencies' => array(
			'access' => array('student'),
			'title' => '',
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2cg_competencies_content()
		),
		'progress' => array(
			'access' => array('student'),
			'title' => '',
			...
			'icon' => '',
			'links' => '',
			'content' => theme_mb2cg_progress_content()
		),
		'contacts' => array(
			'access' => array('student'),
			...
			'icon' => 'fa fa-users',
			'links' => '',
			'content' => theme_mb2cg_contacts_content(1,$context)
		),
		'qbank' => array(
		...
		'badges' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-trophy',
			'links' => theme_mb2cg_links_badges()
		),
		'badges2' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-trophy',
			'links' => theme_mb2cg_links_badges(false)
		),
		'course_settings' => array(
			...
			'desc' => '',
			'icon' => 'fa fa-book',
			'links' => theme_mb2cg_links_course()
		),
		'students' => array(
			'access' => array('admin','manager','editingteacher'),
			...
			'links' => theme_mb2cg_links_students()
		),
		'students2' => array(
			'access' => array('teacher'),
			'title' => get_string('defaultcoursestudents'),
			'desc' => '',
			'icon' => 'fa fa-graduation-cap',
			'links' => theme_mb2cg_links_students(false)
		)
 ...
 *
 */
function theme_mb2cg_studentbadges_content()
{
 ...
 *
 */
function theme_mb2cg_competencies_content()
{
 ...
 *
 */
function theme_mb2cg_grades_content()
{
 ...
 *
 */
function theme_mb2cg_progress_content()
{
 ...
 *
 */
function theme_mb2cg_get_role_name($context,$user,$shortname)
{
 ...
 *
 */
function theme_mb2cg_contacts_content()
{
	...
	$roleshortname = theme_mb2cg_theme_setting($PAGE,'roleshortname','editingteacher');
	$teacheremail = theme_mb2cg_theme_setting($PAGE,'teacheremail');
	$teachermessage = theme_mb2cg_theme_setting($PAGE,'teachermessage');
		...
		$output .= '<ul>';
			...
			if ($count>0)
			{
				...
				foreach ($teachers as $teacher)
				{
					...
					$rolename = theme_mb2cg_get_role_name($context,$teacher,$roleshortname);
 ...
 *
 */
function theme_mb2cg_course_content()
{
	...
	$output = '';
	$banner = theme_mb2cg_course_banner_url();
	...
	$limit = theme_mb2cg_theme_setting($PAGE,'cpaneldesclimit',24);
	$content = theme_mb2cg_wordlimit($COURSE->summary,$limit);


	$output .= '<h3>' . theme_mb2cg_wordlimit($COURSE->fullname,6) . '</h3>';
 ...
 *
 */
function theme_mb2cg_links_students($edit = true)
{
	...
	$links = array(
		...
		array('url'=>new moodle_url('/report/loglive/index.php',array('id' => $COURSE->id)),'title'=>get_string('livelogs','theme_mb2cg')),
		array('url'=>new moodle_url('/report/participation/index.php',array('id' => $COURSE->id)),'title'=>get_string('courseparticipation','theme_mb2cg')),
 ...
 *
 */
function theme_mb2cg_links_course()
{
	...
	$links = array(
		...
		array('url'=>new moodle_url('/admin/tool/recyclebin/index.php',array('contextid' => $PAGE->context->id)),'title'=>get_string('recyclebin','theme_mb2cg'),'showif'=>$ifm33),
		array('url'=>new moodle_url('/filter/manage.php',array('contextid' =>  $PAGE->context->id)),'title'=>get_string('filters','admin')),
		array('url'=>new moodle_url('/admin/tool/monitor/managerules.php',array('courseid' => $COURSE->id)),'title'=>get_string('eventmonitoring','theme_mb2cg'))
	);
 ...
 *
 */
function theme_mb2cg_links_badges($edit = true)
{
 ...
 *
 */
function theme_mb2cg_links_qbank()
{
 ...
 *
 */
function theme_mb2cg_links_activities()
{
	...
	$data = theme_mb2cg_get_course_activities();
