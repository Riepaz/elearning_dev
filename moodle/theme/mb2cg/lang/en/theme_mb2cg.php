...
$string['choosereadme'] = 'Hey, I\'m Cognitio Theme';


// Human readable name of the plugin.
$string['pluginname'] = 'Cognitio';
...
// Check plugins
$string['mb2slider_plugin'] = '<strong>Mb2 Slider</strong> block must be installed. Please see <a href="https://mb2themes.com/docs/cognitio/#slider_installation" target="_blank">documentation</a>.';
$string['mb2content_plugin'] = '<strong>Mb2 Content</strong> block must be installed. Please see <a href="https://mb2themes.com/docs/cognitio/#mb2content_installation" target="_blank">documentation</a>.';
$string['mb2shortcodes_filter_plugin'] = '<strong>Mb2 Shortcodes Filter</strong> plugin must be <strong>installed</strong> and <strong><u>activated</u></strong>. Please see <a href="https://mb2themes.com/docs/cognitio/#sc_filter" target="_blank">documentation</a>.';
$string['mb2shortcodes_button_plugin'] = '<strong>Mb2 Shortcodes Button</strong> plugin must be installed. Please see <a href="https://mb2themes.com/docs/cognitio/#sc_button" target="_blank">documentation</a>.';
...
$string['region-after-slider-a'] = 'After Slider A';
$string['region-after-slider-b'] = 'After Slider B';
$string['region-after-content'] = 'After Content';
$string['region-after-content-a'] = 'After Content A';
$string['region-after-content-b'] = 'After Content B';
$string['region-before-content'] = 'Before Content';
$string['region-before-content-a'] = 'Before Content A';
$string['region-before-content-b'] = 'Before Content B';
...
$string['region-before-footer'] = 'Before Footer';
$string['region-before-footer-a'] = 'Before Footer A';
$string['region-before-footer-b'] = 'Before Footer B';
$string['region-after-footer'] = 'After Footer';
$string['region-after-footer-a'] = 'After Footer A';
$string['region-after-footer-b'] = 'After Footer B';
$string['region-footer-a'] = 'Footer A';
$string['region-footer-b'] = 'Footer B';
$string['region-footer-c'] = 'Footer C';
$string['region-footer-d'] = 'Footer D';
$string['region-after-header'] = 'After Header';


// Settings tabs
$string['configtitle'] = 'Cognitio';
...
$string['urldoc'] = 'https://mb2themes.com/docs/cognitio';
...
$string['logomt'] = 'Logo Margin Top (px)';
...
$string['cbanner'] = 'Course Banner';
$string['info'] = 'Site Info';
$string['infocustom'] = 'Custom Information';
$string['emailname'] = 'Email Name';
$string['emaillink'] = 'Email Link';
$string['phonename'] = 'Phone Name';
$string['locationname'] = 'Location Name';
$string['custominfoicon'] = 'Custom Icon';
$string['custominfoname'] = 'Custom Info Name';
$string['custominfo'] = 'Custom Info';
$string['shsidebars'] = 'Show/Hide Sidebars';
...
$string['navicon'] = 'Icon Menu';
$string['urlnw'] = 'Open Links in a New Window';
...
$string['navtopfooter'] = 'Top and Footer Menu';
$string['topmenu'] = 'Top Menu Items';
$string['footermenu'] = 'Footer Menu Items';
$string['menudesc'] = 'Each line consists separated by pipe characters "|":<br>text|url::"1" to open link in a new window|language code or comma-separated codes|"1" to show item for logged in users only or "2" to show item for none logged in users only.<br>For example:<pre>Menu item|http://example.com
...
$string['homeitem'] = 'Home Link in Menu';
...
$string['searchform'] = 'Search Form';
$string['searchboth'] = 'Show Search Courses form if Global Search is Enabled';
$string['loginlink'] = 'Form Text Link';
...
$string['loginadditional'] = 'Additional Links';
$string['opturl'] = 'Optional url.';
$string['usability'] = 'Usability';
$string['fontsizer'] = 'Font size switcher';
$string['contrast'] = 'Contrast version';
...
$string['pbgdesc'] = 'To see page background color or image you need ot use \'Fixed\' page layout.';
...
$string['btstyle'] = 'Bottom';
$string['bfstyle'] = 'Before Footer';
$string['afstyle'] = 'After Footer';
...
$string['headerstyleheading'] = 'Main Header';
$string['headerstyle'] = 'Header Style';
$string['scustomcssstyleheading'] = 'Custom Css Style';
$string['customcss'] = 'Custom Css Code';
$string['fcolw'] = 'First Column Grid Number';
$string['sectionfcolwdesc'] = 'This section contains two columns. Default width of these columns is 6 which is half of full grid (6+6=12). In theme options you may change default width of the first column, the second column width will be set automatically. For example set this field to "8" and you will get width of the first column 8 and width of the second column 4 (8+4=12).';
$string['hstylelight2'] = 'Light and dark navigation';
$string['hstylelight3'] = 'Light and color navigation';
$string['blockmarginb'] = 'Block Margin Bottom (px)';
$string['blockmarginbdesc'] = 'Margin bottom of blocks placed in regions of this section.';
$string['headerctop'] = 'Content Margin Top (px)';
...
$string['lessvars'] = 'Less variables';
...
$string['fsizepxdesc'] = 'Set font size in pixels for normal, bigger and bigger2 fonts size.';
...
$string['langinmenu'] = 'In main menu';
$string['langinheader'] = 'In header';
$string['langmenu'] = 'Languages Menu';


// Frontend
$string['logininfo'] = 'Forgot username or password?';
